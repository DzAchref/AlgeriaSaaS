// ============================================
// Algeria SaaS Ecosystem — Shared Types
// ============================================
...
export const LOCALE_CONFIG: Record<SupportedLocale, { name: string; dir: TextDirection; nativeName: string }> = {
  'fr-DZ': { name: 'French (Algeria)', dir: 'ltr', nativeName: 'Français' },
  'ar-DZ': { name: 'Arabic (Algeria)', dir: 'rtl', nativeName: 'العربية' },
};
...
export interface InvoiceLineItem {
  ...
  quantity: number;
  unitPrice: number;
  tvaRate: number;       // 0.19 or 0.09 or 0
  tvaAmount: number;
  totalHT: number;
  totalTTC: number;
}
...
export interface Invoice {
  id: string;
  tenantId: string;
  invoiceNumber: string;  // Sequential, DGI-compliant
  type: InvoiceType;
